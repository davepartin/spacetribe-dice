...
**Do I widen now or save? — Strong.** Slot prices rise 7 / 8 / 9 / 10. The
...
**How many ships protect the flagship? — Strong.** Each selected ship blocks its
size and misses the next round. The player chooses how much health to preserve
now and how many dice to give up next round.

**Which ships take it? — Strong.** The player weighs block size, current fleet
shape, upcoming growth, and straight coverage. Several smaller ships may cover
the same volley as one valuable large ship. Direct bypasses this choice.
