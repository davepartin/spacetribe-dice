              ...
              <div className="fleet-die shop-flag shop-flagship static">
                ...
                {flagCost ? (
                  <button
                    ...
                    type="button"
                  >
                    Level {you.flag.level + 1} · {flagCost}⚡
                  </button>
                ) : (
                  <span className="ship-act ship-act-maxed">Max level</span>
                )}
              </div>
            )}
            renderLocked={(index) => {
        ...
        <header className="brace-header">
          ...
          <p className="brace-lead">
            {doomed ? (
              ...
              <>
                Choose ships to protect your flagship. Tap a ship to block, tap it
                again to take it off. Each ship you use is <b>damaged for one round</b>.{" "}
